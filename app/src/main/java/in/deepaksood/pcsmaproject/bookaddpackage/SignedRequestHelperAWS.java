 ...
 */
public class SignedRequestHelperAWS {
    ...
    private String awsAccessKeyId = "AKIAIFNPMUP4SVS3RXTA";
    private String awsSecretKey = "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";

    private SecretKeySpec secretKeySpec = null;
    private Mac mac = null;

    public SignedRequestHelperAWS() {
